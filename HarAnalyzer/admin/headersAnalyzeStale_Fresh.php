...
//        echo $pr['Response_cache_control'];
        if (!empty($pr['Response_cache_control']) ) {
            ...
            $temp2 = False;
            if (strpos($pr['Response_cache_control'], "stale-while-revalidate=") !== false) {
//                print_r($temp2);
                $temp2 = explode("stale-while-revalidate=", $pr['Response_cache_control'])[1];
                $temp2 = True;
//                echo $temp2."<br>";
            }
            if (strpos($pr['Response_cache_control'], "min-fresh=") !== false) {
                print_r($temp2);
...
//            }
            ...
            $myObjectDir = new stdClass();
            $myObjectDir->stale_while_revalidate = $temp2;
...
//        echo $content_type[$key]->content_type;
    $object->stale_while_revalidate = $cache_dir[$key]->stale_while_revalidate;
    $object->isp = $isp[$key];
